...
const Payments = ({ history }) => {
  // CHANGED: 'selectdOption' to 'selectedOption' here
  const { selectedOption, onChangePaymentOption, cartList, removeAllCartItems } = useContext(CartContext)
      ...
      <div className="payment-container">
        <div className="payments-page">
              ...
              {paymentOptions.map(eachPayment => (
                <li key={eachPayment.id} className="li-item">
                  <input
                    ...
                    // CHANGED: 'selectdOption' to 'selectedOption' here
                    checked={selectedOption === eachPayment.name}
          ...
          <p className="message">
            ...
            {/* CHANGED: 'selectdOption' to 'selectedOption' here */}
            <span className="selected-mode"> {selectedOption}</span>
          </p>
